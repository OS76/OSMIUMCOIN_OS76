...
#if defined(NDEBUG)
# error "OSMIUMCOIN cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xf0526ca352b6527e9a999b3f6e94415ef672fc23b1fe5c821926c7d1c1fd2569");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // OSMIUMCOIN: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "OSMIUMCOIN Signed Message:\n";
...
{
    // OSMIUMCOIN: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // OSMIUMCOIN: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // OSMIUMCOIN: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf0526ca352b6527e9a999b3f6e94415ef672fc23b1fe5c821926c7d1c1fd2569");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1444109079, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "OSMIUMCOIN 76 SCRYPT";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 2 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045198ecba81e2ba6401b5f4592b0477ecb8bad65b40afa73b5156fee8f528cae3d156a944b816a83a36d22d7118fcd541d4b75e9dc399e445bcdab9b7bea91323") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1444109079;
        ...
        assert(block.hashMerkleRoot == uint256("0xcb73bbddada0c1c12c8984cead03de16cc29ff64addfe7330921573ef058ae1a"));
...
unsigned char pchMessageStart[4] = { 0xef, 0x07, 0x67, 0xff }; // OSMIUMCOIN: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OSMIUMCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OSMIUMCOINMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static OSMIUMCOINMiner(CWallet *pwallet)
{
    printf("OSMIUMCOINMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("osmiumcoin-miner");
    ...
    try { loop {
        ...
        printf("Running OSMIUMCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("OSMIUMCOINMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&OSMIUMCOINMiner, pwallet));
}
